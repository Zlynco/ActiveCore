...
<head>
    ...
    <title>Active Core Forgot Password</title>
...
<body class="bg-gradient-primary">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-password-image">
                                <img src="image/image 2.png" alt="image login" >
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
    ...
    <script src="{{ asset('startbootstrap-sb-admin-2-master/vendor/jquery/jquery.min.js') }}vendor/jquery/jquery.min.js"></script>
