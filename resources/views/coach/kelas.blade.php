    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 mb-4">
                ...
                <!-- Form Filter -->
                <form method="GET" action="{{ route('coach.kelas') }}" class="p-4 mb-0" >
                    ...
                    <div class="card-body" >
                        <div class="row" id="classList" style="max-height: 400px; overflow-y: scroll;">
                            @foreach ($classes as $class)
                                <div class="col-sm-6 col-md-4 mb-4 class-item" data-name="{{ strtolower($class->name) }}">
                                    <div class="card shadow">
                                        ...
                                        @else
                                            <img src="{{ asset('images/default-class-image.png') }}" class="card-img-top"
                                                ...
                                                <div class="modal-body">
                                                    @if ($class->image)
                                                        <img src="{{ Storage::url($class->image) }}" 
                                                             class="img-fluid mb-3" alt="{{ $class->name }}">
                                                    @endif
                                                    ...
                                                    <p><strong>Registered Count:</strong> {{ $class->registered_count }}</p>
                                                </div>
