...
<head>
    ...
    <title>Active Core Dashboard</title>
...
<body id="page-top">
    ...
    <!-- Page level plugins -->
    <script src="{{ asset('startbootstrap-sb-admin-2-master/vendor/chart.js/chart.min.js') }}vendor/chart.js/Chart.min.js"></script>
